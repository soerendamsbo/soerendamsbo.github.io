...
subtitle: How experiencing climate change shapes our political lives
---

- PhD thesis submitted September 5, 2023, and defended January 9, 2024
- Department of Political Science, University of Copenhagen
- Supervisors: Kasper M. Hansen and Frederik Hjorth
- The PhD thesis can be [downloaded from here](https://web.tresorit.com/l/Hk1AI#iJCuKFJev4lXCJejdiUzbA) using the password '*poliweather*'
- You can also take a look at the [slides from my PhD defense](https://soerendamsbo.github.io/misc-slides/phd-defense_updated.html)
...
<br>
![](media/cover.png){width=300px style="border: 1px solid #000000;"}
