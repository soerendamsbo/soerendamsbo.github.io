...
::: {.columns}
::: {.column width="50%"}
- Submitted September 5 2023 and defended January 9 2024
- Department of Political Science, University of Copenhagen
- Supervisors: Kasper M. Hansen and Frederik Hjorth
- The thesis can be downloaded from [here](https://web.tresorit.com/l/Hk1AI#iJCuKFJev4lXCJejdiUzbA) using the password '*poliweather*'.
